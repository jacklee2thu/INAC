...
setwd(output_dir)
save(patient_tss1000,patient_tss150,file=paste0(sample_name,"_alltss.Rdata"))
...
###########
temp_tss_2K<-all_sample_tss[[1]][,2]
save(temp_tss_2K,file=paste0(sample_name,'_tss_2K.Rdata'))
