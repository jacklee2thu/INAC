...
position = position_dodge(0.8))+labs(title = "cfDNA_numreads")
ggbarplot(LJ_10_12_he_coverage, x = "rname", y = "meanmapq", 
          add = c("mean_se"),sort.by.groups=T,
          color = "red2",fill = "red2", palette = "npg",
position = position_dodge(0.8))+labs(title = "cfDNA_meanmapq")
ggbarplot(LJ_10_12_he_coverage, x = "rname", y = "coverage", 
          add = c("mean_se"),sort.by.groups=T,
          color = "red2",fill = "red2", palette = "npg",
position = position_dodge(0.8))+labs(title = "cfDNA_coverage")
ggbarplot(LJ_10_12_he_coverage, x = "rname", y = "meandepth", 
          add = c("mean_se"),sort.by.groups=T,
          color = "red2",fill = "red2", palette = "npg",
position = position_dodge(0.8))+labs(title = "cfDNA_meandepth")
dev.off()
